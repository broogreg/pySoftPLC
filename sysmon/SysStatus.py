...
class SysStatusContainer:
	...
	def GetSysSummary(self):
		...
		tcpclientstatuslist = [client.GetStatusInfo() for client in tcpclientlist]
		tcpclientrunlist = [client for client in tcpclientstatuslist if client['constatus'] != 'running']
		tcpclientmsglist = [client for client in tcpclientstatuslist if client['cmdsummary'] != 'ok']

		# Do the same for generic clients.
		genclientstatuslist = [client.GetStatusInfo() for client in genclientlist]
		genclientrunlist = [client for client in genclientstatuslist if client['constatus'] != 'running']
		genclientmsglist = [client for client in genclientstatuslist if client['cmdsummary'] != 'ok']
